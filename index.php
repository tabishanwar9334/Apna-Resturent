		...
		<ul class="slides-container">
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> Hotel Apna Restaurant</strong></h1>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							...
							<p class="m-b-40">Apna Restaurant is serving a Authentic Apna Food.And Restaurant's 
<br> 
			...
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> Yamifood with Apna</strong></h1>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 text-center">
					<div class="inner-column">
						<h1>Welcome To <span>Apna Restaurant</span></h1>
						<h4>Little Story</h4>
						<p>Restaurants in Ranchi, Apna Restaurants, Ranchi restaurants, ,    
Gujarati Restaurants in Bopal, 
 </p>
						<p>Quick Bites in Ahmedabad, Quick Bites near me, Quick Bites in Ranchi, Quick Bites in Jharkhand, in Jamsedpur, near me, in West Ranchi,   near me, in Hotel Landmark, in Lalpur , New Year Parties in Ahmedabad, Christmas' Special in Ahmedabad,</p>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 ml-auto mr-auto text-center">
					...
					<span class="lead">Apna Restaurent</span>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Gallery</h2>
						<p>Delicious food Pictures for Apna Restaurent Listed Here </p>
					</div>
				</div>
			</div>
