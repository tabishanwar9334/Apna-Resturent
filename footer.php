	...
	<footer class="footer-area bg-f">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					...
					<p class="lead">Circular Road Lalpur,</p>
					<p class="lead"><a href="#">+91 6200072389</a></p>
					<p><a href="#"> Apna@gmail.com</a></p>
				</div>
				<div class="col-lg-3 col-md-6">
					<h3>Opening hours</h3>
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<p class="company-name"> &copy; 2020 <a href="#">Apna Restaurant</a> Developed By : lifetech
					<a href=""></a><br>
